 ...
 * Date:     2020年4月15日 下午6:41:16
 * @author   sixinyiyu@gmail.com
 * @version  1.0
 * @since    JDK 1.8
 */
public class SnowflakeSequence implements ISequenceService {

	/** 起始的时间戳 */
    private final static long START_STMP = 1555331891296L;
